...
const Header = (props: any) => {
    ...
    const onOk = (values: Values) => {
        ...
        let username = (store.getState() as any).user.data.username;
    ...
    return (
        <div className="header-container">
            <div className="header">
                 <div className="section">
                    ...
                    {/*<ul>
                        ...
                        <li>
                            <a href="/electronicMedicalRecord" rel="noopener noreferrer">电子病历</a>
                        </li>
                        <li>
                            <a href="/healthPortrait" rel="noopener noreferrer">健康画像</a>
                        </li>
                        <li>
                            <a href="/oprescription" rel="noopener noreferrer">处方单</a>
                        </li>
                        <li>
                            <a href="/nlineCommunication" rel="noopener noreferrer">线上交流</a>
                        </li>
                    </ul>*/}
                </div> 
                ...
                <Dropdown overlay={ menu }>
                    <a className="dropdown-link" href="/#" onClick={ e => e.preventDefault() }>
                        <span className="username">{ (store.getState() as any).user.data.username }</span>
            ...
            <a href="http://localhost:7100" target="_blank" rel="noopener noreferrer" className="github-corner">
